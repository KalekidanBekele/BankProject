function sendMoney(){
    ...
    else
    {
       ...
       var textNode = document.createTextNode(`Rs ${enterAmount} is sent from the sender with the username of ${enterSName}
       to recepient with the username of ${enterName} on ${Date()}.`);
